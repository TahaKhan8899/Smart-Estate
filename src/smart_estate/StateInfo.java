...
public class StateInfo {
	...
	/**
	 * @brief setting of hpi value with assumption that this method is only called
	 *        once per object
	 * @param hpi
	 *            HPI of state
	 */
	...
	/**
	 * @brief setting of crime rate value with assumption that this method is only
	...
	/**
	 * @brief setting of housing price value with assumption that this method is
	 *        only called once per object
	 * @param housing_price
	 *            housing price of state
	 */
