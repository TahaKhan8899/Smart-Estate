...
public class ReadCrimeRate {
	...
	public static Pair[] load_crime_data(String s) {
		try {
			...
			String[] states = StateGen.readStates();
				
				/* { "Alabama", "Alaska", "Arizona", "Arkansas", "Calidornia", "Colorado", "Connecticut",
					"Delware", "Florida", "Gerogia", "Hawii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas",
